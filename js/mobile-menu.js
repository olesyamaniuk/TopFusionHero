document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".w-s-navigation-list");
  const headerRef = document.querySelector(".w-s-header");
  const navigationRef = document.querySelector(".w-s-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".w-s-toggle-button img");
